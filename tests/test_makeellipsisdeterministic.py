...
from src.preprocess.pattern import Pattern_EllipsisMatchModeRewriter, DefineLanguage_NtClosureSolver
...
class TestMakeEllipsisDeterministic(unittest.TestCase):
    ...
    def test_partitioning(self):
        ...
        partitions = Pattern_EllipsisMatchModeRewriter._partitionseq(None, seq1)
